...
class RegisterPasienPemeriksaanFisik_model extends CI_Model {

    private $table_name = 'register_pasien_pemeriksaan_fisik'; //nama tabel dari database
    private $view_name = 'register_pasien_pemeriksaan_fisik'; //nama tabel dari database
