...
class RegisterPasienIcd9_model extends CI_Model {

    private $table_name = 'register_pasien_icd9'; //nama tabel dari database
    private $view_name = 'v_register_pasien_icd9'; //nama tabel dari database
