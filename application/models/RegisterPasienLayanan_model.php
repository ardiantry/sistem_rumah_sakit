...
class RegisterPasienLayanan_model extends CI_Model {

    private $table_name = 'register_pasien_layanan'; //nama tabel dari database
    private $view_name = 'v_register_pasien_layanan'; //nama view dari database
