...
class RegisterPasienPaket_model extends CI_Model {

    private $table_name = 'register_pasien_paket'; //nama tabel dari database
    private $view_name = 'v_register_pasien_paket'; //nama view dari database
    ...
    {
        $query = $this->db->get_where($this->view_name, array('id_reference' => $id));
        return $query->row();        
    }         
}