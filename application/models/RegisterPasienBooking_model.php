...
class RegisterPasienBooking_model extends CI_Model
{
    private $dbcon;
    private $primary_key = "id";
    private $table_name = 'register_pasien'; //nama tabel dari database
    private $view_name = 'v_register_pasien_booking'; //nama tabel dari database
    private $allow_search_column = array('name'); //field yang diizin untuk searching
    private $allow_order_column = array(null, 'name'); //field yang diizin untuk sorting;
    private $default_order_column = array('name' => 'asc'); // default order
