...
class RawatInapRencanaKontrol_model extends CI_Model {

    private $table_name = 'rawat_inap_rencana_kontrol'; //nama tabel dari database 
    private $view_name = 'v_rawat_inap_rencana_kontrol_sms'; //nama tabel dari database 
