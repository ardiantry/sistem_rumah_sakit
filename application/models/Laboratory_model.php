...
class Laboratory_model extends CI_Model {
    ...
    private $table_name = 'laboratory'; //nama tabel dari database
    private $view_name = 'v_laboratory'; //nama tabel dari database
    ...
    public function getDataTable($parameter, $where)
    {
        $columns = array(
            ...
            [
                ...
                //     $date = new DateTime($row["tanggal_daftar"]);
                //     return $date->format(DateTime::ATOM); //or any other format you require
                //   }                
            ], 
            [
                "db" => "tanggal_masuk",
            ...
            [
                "db" => "id_laboratory_type",
                "dt" => "id_laboratory_type",
            ],                             
            [
                "db" => "id_pasien",
                "dt" => "id_pasien",
