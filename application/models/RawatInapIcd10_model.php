...
class RawatInapIcd10_model extends CI_Model {

    private $table_name = 'rawat_inap_icd10'; //nama tabel dari database
    private $view_name = 'v_rawat_inap_icd10'; //nama tabel dari database
