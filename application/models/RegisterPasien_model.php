...
class RegisterPasien_model extends CI_Model
{
    private $dbcon;
    ...
    {
        $this->db->query("UPDATE register_pasien SET state_index = 4 WHERE id=" . $id);        
        $this->db->query('INSERT INTO rawat_inap(id_klinik, id_pasien, no_registrasi, tanggal_periksa, id_dokter, id_tipe_pasien, keterangan1, id_reference)
        SELECT id_klinik, id_pasien, DATE_FORMAT(NOW(), "RI%Y%m%d%H%i%s") no_registrasi, tanggal_periksa, id_dokter, id_tipe_pasien, keterangan1, id id_reference
