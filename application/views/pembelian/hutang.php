                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="inputNoPo" name="inputNoPo" class="form-control form-control-sm" readonly required value="<?= $Pembelian->no_po; ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date datepicker" id="dateTanggalPesan" data-target-input="nearest">
                                                            <input type="text" id="inputTanggalPesan" name="inputTanggalPesan" class="form-control form-control-sm datetimepicker-input" data-target="#dateTanggalPesan" required value="<?= $Pembelian->tanggal_po; ?>" readonly />
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-sm mb-1">
                                                            <select class="form-control form-control-sm custom-select custom-select-sm" id="inputSupplier" name="inputSupplier" required disabled>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                    ...
                                                    <div class="input-group input-group-sm mb-1 d-none">
                                                        <input class="form-control form-control-sm" placeholder="Ketik Obat" id="inputObatPo" autocomplete="off" readonly>
                                                        ...
                                                        <table class="table table-hover table-sm" id="tableObatPo">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    ...
                                                                    <th data-label="button_delete" class="text-right align-middle d-none"></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-6">
                                                    ...
                                                    <textarea class="form-control form-control-sm" rows="3" id="inputKeteranganPO" name="inputKeteranganPO" placeholder="Ketik Keterangan" readonly></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="inputNoFaktur" name="inputNoFaktur" class="form-control form-control-sm" required value="" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group date datepicker" id="dateTanggalFaktur" data-target-input="nearest">
                                                            <input type="text" id="inputTanggalFaktur" name="inputTanggalFaktur" class="form-control form-control-sm datetimepicker-input" data-target="#dateTanggalFaktur" required value="<?= $Pembelian->tanggal_pr; ?>" readonly />
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group-sm mb-1">
                                                            <select class="form-control form-control-sm custom-select custom-select-sm" id="inputLokasi" name="inputLokasi" required disabled>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="input-group input-group-sm mb-1 d-none">
                                                        <input class="form-control form-control-sm" placeholder="Ketik Obat" id="inputObatPr" autocomplete="off" readonly>
                                                        <div class="input-group-append">
                                                            <button class="btn btn-secondary" type="button">Cari</button>
                                                        </div>
                                                    </div>
                                                    <div class="table-responsive-sm">
                                                        <table class="table table-hover table-sm" id="tableObatPr">
                                                            <thead class="thead-light">
                                                                <tr>
                                                                    ...
                                                                    <th data-label="harga_obat" class="text-right align-middle" style="width:10%;">Harga Beli</th>
                                                                    <th data-label="total" class="text-right align-middle" style="width:10%;">Total</th>
                                                                    <th data-label="exp_date" class="text-center align-middle" style="width:10%;">Expired Date</th>
                                                                    <th data-label="batch_no" class="text-center align-middle d-none" style="width:10%;">Batch Number</th>
                                                                    <th data-label="button_delete" class="text-right align-middle d-none" style="width:80px;"></th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <textarea class="form-control form-control-sm" rows="3" id="inputKeteranganPr" name="inputKeteranganPr" placeholder="Ketik Keterangan" readonly></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-sm">
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right align-middle">Rp <span id="spanSubtotal"></span>,-</td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right align-middle">Rp <span id="spanDiskon"></span>,-</td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right align-middle">Rp <span id="spanPajak"></span>,-</td>
                                                                </tr>
                                                            </table>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <table class="table table-sm">
                                                            <tr>
                                                                ...
                                                                <td></td>
                                                                <td style="width:40%" class="text-right align-middle">
                                                                    <select class="form-control form-control-sm custom-select custom-select-sm" id="inputCaraBayar" name="inputCaraBayar" required>
                                                                        <option selected disabled>--pilih cara bayar--</option>
                                                                    </select>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <div class="inner text-right">
                                                                <table class="table table-sm table-borderless">
                                                                    ...
                                                                    <tr class="d-none">
                                                                        ...
                                                                        <td>Rp <span id="spanTotalBayar"></span>,-</td>
                                                                    </tr>
                                                                    <tr class="d-none">
                                                                        <td class="text-left align-middle">Kembalian</td>
                                                                        <td>Rp <span id="spanKembalian"></span>,-</td>
                                                                    </tr>
                                                                </table>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row no-print">
                                                <div class="col-12">
                                                <button type="button" class="btn btn-secondary btn-print d-none"><i class="fas fa-print"></i> Cetak</button>
