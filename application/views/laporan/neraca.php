                ...
                <div class="card-footer justify-content-between ">
                    ...
                    <div class="form-group d-none">
                        ...
                        <select class="form-control form-control-sm custom-select custom-select-sm" name="pilih_group" id="pilih_group">
                            ...
                            <option value="1.1">Harta Lancar</option>
                            <option value="1.2">Harta Tetap</option>
                            <option value="2">Hutang</option>
                            <option value="2.1">Hutang Jangka Pendek</option>
                            <option value="2.2">Hutang Jangka Panjang</option>
