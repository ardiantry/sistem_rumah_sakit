                ...
                <table class="table table-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="d-none">
                            ...
                            <td style=" white-space: nowrap;" class="text-right"><?= (($grand_total_debit - $grand_total_kredit) < 0) ? "<span style='color:red'>(" . rupiah(ABS($grand_total_debit - $grand_total_kredit)) . ")</span>" : rupiah($grand_total_debit - $grand_total_kredit) ?></td>
                        </tr>                        
                    </tbody>
                </table>
            </div>
