    ...
    <section class="invoice p-2">
          ...
          <h2 class="page-header row">
            ...
            <div class="col">
              ...
              <h5 class="text-center">
                <small>No Transaksi: <b><?= $transaksi->no_transaksi; ?></b></small><br>
              </h5>
            </div>
            <div class="col">
      ...
      <div class="row invoice-info">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 offset-xl-4 offset-lg-4">
          <?php 
              if($transaksi->no_pelanggan !== null){
            ?>
          Dari:            
          <address>
            <strong><?= $transaksi->nama_pelanggan; ?> (<?= $transaksi->no_pelanggan; ?>)</strong><br>
            <?= $transaksi->alamat; ?><br>
          ...
          <table class="table">
            ...
            <?php
              ...
              <tr>
                ...
                <td class="text-right" style="width: 1%;white-space:nowrap;"><b><?= rupiah($transaksi->total_bayar - $transaksi->kembalian); ?></b></td>
              </tr>
            </tbody>
          </table>
