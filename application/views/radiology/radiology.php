...
No.asuransi:
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputPetugas">Dokter/Petugas</label>
								...
								?>	
                                                    ...
                                                    <div class="form-group">
                                                        <label for="inputJenisLab">Jenis Radiology</label>
                                                        <select class="form-control form-control-sm custom-select custom-select-sm" id="inputJenisRad" name="inputJenisRad" disabled required>
                                                            <option selected disabled value="">--pilih jenis rad--</option>
                                                            <?php								
...
<div class="modal fade" id="modal-registrasi">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
                <h4 class="modal-title">Data Radiology</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body  table-responsive"> 
                   <table id="tablePasienRadiology" class="table table-striped text-nowrap">
                        <thead>
                            <tr>
                                <th></th>
                                <th>No registrasi</th>
