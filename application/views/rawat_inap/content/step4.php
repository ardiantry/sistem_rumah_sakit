				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6">
						<table class="table table-borderless table-sm text-nowrap">
							...
							<tr>
								<th>Tanggal Masuk</th>
								<td>:&nbsp; <span id="TglMasuk"></td>
							</tr>
							<tr>
								<th>Tanggal Keluar</th>
								<td>:&nbsp; <span id="TglKeluar"></td>
							</tr>
						</table>
					</div>
					<!-- /.col -->
			...
			<div class="card-body">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-lg-7">
						<div class="row">
						  <div class="col-sm-12 col-md-12 col-lg-12" id="rincian_kamar">
								<label for="tableInvoiceKamar">Rincian Kamar</label>
								<div class="table-responsive-sm">
									<table class="table table-hover table-sm text-nowrap" id="tableInvoiceKamar">
										<thead class="thead-light">
											<tr>
												<th class="text-center align-middle" style="width:15%;">Hari</th>
												<th class="text-left align-middle">Nama Kamar</th>
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								<label for="tableInvoiceLab">Rincian Laboratorium</label>
								<div class="table-responsive-sm">
									<table class="table table-hover table-sm text-nowrap" id="tableInvoiceLab">
										<thead class="thead-light">
											<tr>
												<th class="text-center align-middle" style="width:15%;">Tanggal</th>
												<th class="text-left align-middle">Jenis Laboratorium</th>
												<th class="text-right align-middle" style="width:20%;">Harga</th>
												<th class="text-right align-middle" style="width:10%;">Total</th>
											</tr>
										</thead>
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								<label for="tableInvoiceRad">Rincian Radiologi</label>
								<div class="table-responsive-sm">
									<table class="table table-hover table-sm text-nowrap" id="tableInvoiceRad">
										<thead class="thead-light">
											<tr>
												<th class="text-center align-middle" style="width:15%;">Tanggal</th>
												<th class="text-left align-middle">Jenis Radiologi</th>
												<th class="text-right align-middle" style="width:20%;">Harga</th>
												<th class="text-right align-middle" style="width:10%;">Total</th>
											</tr>
										</thead>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							...
							<div class="input-group input-group-sm mb-1">
								<select class="form-control form-control-sm custom-select custom-select-sm" id="inputCaraBayar" name="inputCaraBayar">
									...
									<?php								
									foreach($cara_bayar as $rows)
									{								
										echo "<option value='{$rows->id}' data-akun='{$rows->id_akun}'>{$rows->cara_bayar}</option>";
									}
								?>										
								</select>
