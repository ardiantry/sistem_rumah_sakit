...
<body>
  <div class="wrapper">
    ...
    <section class="invoice p-2">
      ...
      <!-- /.row -->
      <?php
        $tgl_masuk = new DateTimeImmutable($register->tanggal_masuk);
        $tgl_keluar = new DateTimeImmutable($register->tanggal_keluar);
        $interval = $tgl_masuk->diff($tgl_keluar);

        $hour = $interval->h;
        $total_menginap = ($hour > 0) ? $interval->d + 1 : $interval->d;
      ?>
      <div class="row">
          ...
          <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $register->nama_bed; ?></td>
                    <td class="text-right"><?= $total_menginap; ?></td>
                    <td class="text-right text-nowrap"><?= rupiah($register->tarif); ?></td>
                    <td class="text-center">hari</td>
                    <td class="text-right text-nowrap"><?= rupiah($total_menginap * $register->tarif); ?></td>
                </tr> 
              <?php
                $i = 2;              
            		if (count($layanan) > 0) {
