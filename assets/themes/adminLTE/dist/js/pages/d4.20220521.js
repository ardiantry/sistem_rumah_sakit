...
$(function() {
    ...
    let id_klinik = $("#nama_klinik").val();
    chartBinding(moment(new Date()).format('YYYY-MM-DD'), id_klinik);

    $("#datePilihTanggal").on("change.datetimepicker", ({ date, oldDate }) => {
        //Use date and oldDate here
        chartBinding(moment(date._d).format('YYYY-MM-DD'), id_klinik);
    });

    $('#nama_klinik').on('change', function() {
        var input_date = $("#pilih_tanggal").val();
        var newdate = input_date.split("/").reverse().join("-");
        chartBinding(newdate, this.value);
    });
});

function chartBinding(date, id_klinik) {

    $.getJSON(BASE_URL + 'Dashboard/getDashboardData', { date: date, id_klinik: id_klinik }, function(data) {
    ...
    $.getJSON(BASE_URL + 'Dashboard/getMonthlyOmzet', { date: date, id_klinik: id_klinik }, function(data) {
    ...
    $.getJSON(BASE_URL + 'Dashboard/getYearlyOmzet', { date: date, id_klinik: id_klinik }, function(data) {
