...
Handlebars.registerHelper('show-content', function (is_show) {
    return (is_show==1) ? "" : "d-none";
})

Handlebars.registerHelper('hide-content', function (is_hide) {
    return (is_hide == 1) ? "d-none" : "";
})

Handlebars.registerHelper('show-status-content', function (status) {
    return (status != "Pending") ? "" : "d-none";
})

Handlebars.registerHelper('hide-status-content', function (status) {
    return (status != "Pending") ? "d-none" : "";
})

Handlebars.registerHelper('disable-content', function (is_disable) {
    return (is_disable == 1) ? "disabled" : "";
})
