...
function RegistrasiBinding($) {
    ...
    var $tablePendaftaranBookingDT = $("#tableRegisterPasienBooking").removeAttr('width').DataTable({
        destroy: true,
        scrollX: true,
        scrollCollapse: true,
    ...
    var $tableRiwayatPasienDT = $("#tableRiwayatPasien").DataTable({
        ...
        columns: [
            { data: "tanggal_pemeriksaan", "render": $.fn.dataTable.render.moment('DD/MM/YYYY'), width: "5%" },            
            { data: "dokter", width: "10%" },            
            { data: "diagnosa", width: "10%" },
            { data: "layanan", width: "10%" },
            { data: "keterangan2", width: "25%" },            
            { data: "obat", width: "10%" },            
            { data: "keterangan3", width: "20%" },                        
            { data: "rencana_kontrol", width: "20%" },                                    
            { data: "id" },
        ],
        columnDefs: [{
                targets: [0],
